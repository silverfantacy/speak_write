<template>
  <div class="flex flex-col items-center justify-center">
    ...
    <label for="audio-upload"
      ...
      <input id="audio-upload" type="file" class="hidden" accept=".mp3,.mp4,.mpeg,.mpga,.m4a,.wav,.webm" ref="fileInput"
        @change="uploadFile" />
    </label>
  </div>
</template>
...
export default {
  setup() {
    ...
    async function transcribeAudio(audioFile, response_format = 'json') {
    ...
    function cropAndSplitAudio(inputFile, outputFilePrefix, startTime, endTime, maxSizeInMB = 10) {
      ...
      console.log("Cropping and splitting audio file");
